...
import { AddCloudConfigComponent } from './add-cloud-config.component';


describe('AddCloudConfigComponent', () => {
  let component: AddCloudConfigComponent;
  let fixture: ComponentFixture<AddCloudConfigComponent>;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      declarations: [ AddCloudConfigComponent ]
    })
    .compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(AddCloudConfigComponent);
  ...
  it('submit() with a model.ID should call apiService.addCloudConfig() and close the dialog', () => {
    component.model.ID = 5
    component.model.Name = 'testname'
    spyOn(component['apiService'], 'addCloudConfig').and.callThrough()
    spyOn(component, 'uploadFileOrText').and.callFake(() => of({}))
    spyOn(component.dialogRef, 'close')
    component.submit()
    expect(component['apiService'].addCloudConfig).toHaveBeenCalledWith(component.model)
